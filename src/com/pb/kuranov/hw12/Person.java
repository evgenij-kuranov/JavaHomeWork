...
public class Person implements Comparable<Person> {
    ...
    public void addContact(Scanner scan, Person person1) {
        ...
        person1.setDateOfBirth(localDate);
        ...
        person1.setPlace(place);
        person1.setRedaction(LocalDateTime.now());
    }
    public void redactContact (Scanner scan, Person person1) {
